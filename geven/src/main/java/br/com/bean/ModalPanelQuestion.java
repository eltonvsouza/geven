...
public class ModalPanelQuestion {
	...
	private ContasapagarBean contasapagarBean;
	private ContasareceberBean contasareceberBean;
	...
	public ContasapagarBean getContasapagarBean() {
		return contasapagarBean;
	}

	public void setContasapagarBean(ContasapagarBean contasapagarBean) {
		this.contasapagarBean = contasapagarBean;
	}
	
	public ContasareceberBean getContasareceberBean() {
		return contasareceberBean;
	}

	public void setContasareceberBean(ContasareceberBean contasareceberBean) {
		this.contasareceberBean = contasareceberBean;
	}
								...
								if(entidade.equals("venda")){
									...
									if(entidade.equals("transportadora")){
										...
										if(entidade.equals("agenda")){
											...
											if(entidade.equals("contasapagar")){
												contasapagarBean.excluir();
											}else{
												if(entidade.equals("configuracao")){
													configuracaoBean.excluir();
												}else{
													if(entidade.equals("contasareceber")){
														contasareceberBean.excluir();
													}
												}
											}
										}
